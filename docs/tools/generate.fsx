...
let githubLink = "http://github.com/zihotki/LFEG"

// Specify more information about your project
let info =
  [ "project-name", "LFEG"
    "project-author", "Vasili Puchko"
    "project-summary", "LFEG - Lighting Fast Excel Generator, framework for efficient generation of excel files"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/LFEG" ]
